        ...
        <article className='py-3'>
            {
                categorias && <div className='container'>
                    <div className='row justify-content-center g-0'>
                        <Grid container spacing={2} columns={categorias.length % 8}>

                            {categorias.map((cat, index) => (

                                <Grid key={cat.id} className='d-flex justify-content-center' size={1}>
                                    <div id={cat.id} className='col-3 d-flex flex-column align-items-center justify-content-start  gap-2 col-sm-3 col-md-3 p-1'>
