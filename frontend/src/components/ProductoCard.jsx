...
export default function ProductoCard({ producto = null, onDetail = null }) {
    return (producto ? (
        <section 
            ...
            className='bg-white border-0 d-flex flex-row h-100 p-3 producto-card' 
            onClick={onDetail ?? null}
            style={{ cursor: onDetail ? 'pointer' : 'default' }}
        >
            <div className='col-4 col-sm-3 col-md-1 d-flex align-items-center'>
            ...
            <div className='col-8 col-sm-9 col-md-11  px-3 d-flex flex-column text-start'>
