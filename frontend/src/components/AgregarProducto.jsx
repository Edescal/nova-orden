    ...
    return (
        <dialog ref={dialog}>
            <div className=' p-3'>
                ...
                <div className='d-flex flex-column flex-md-row gap-3 align-items-start overflow-x-hidden overflow-y-scroll' style={{ maxHeight: "clamp(20vh, 60vh, 70vh)" }}>
                    <div className='d-flex flex-column p-2' style={{ flex: "2 0 0" }} >
                        <div className='ratio ratio-4x3 flex-grow-0 flex-shrink-0 d-flex align-self-center mt-0 mb-3' style={{ flexBasis: 'clamp(80px, 18vw, 140px)' }}  >
                    ...
                    <div className="d-none d-md-flex vr" />

                    <form className='d-flex flex-column w-100 p-2' ref={form} data-precio={producto ? producto.precio : ''} onChange={evt => updateOrderPrice(evt)} style={{ flex: "3 0 0" }} >
