        ...
        <>
            ...
            <main className='container-fluid'>
                ...
                <div className='container-fluid g-0 p-0 m-0'>
                    <div className='row py-3 justify-content-center mb-3'>
                        <SearchBar func={searchProductos} />
                        <Categorias />
                    </div>
                    {
                        categorias.map(categoria => (categoria.productos.length > 0 ?
                            <article key={categoria.id} className='container-fluid g-0 mb-4 categoria' id={categoria.nombre.split(' ').join('-').toLowerCase()}>
                                <h5 className='rounded-top-4 bg-dark text-white text-center mb-0 px-3 categoria-nombre'>{categoria.nombre}</h5>
                                {
                                    categoria.productos.map(producto => (
                                        <ProductoCard key={producto.id} producto={producto} onDetail={() => {
                    ...
                    <div className='container-fluid d-flex flex-column align-items-center row-gap-3 no-items-shown d-none p-3'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M14.986 3.51a9 9 0 1 0 1.514 16.284c2.489 -1.437 4.181 -3.978 4.5 -6.794" />
                            <path d="M10 10h.01" />
                            <path d="M14 8h.01" />
